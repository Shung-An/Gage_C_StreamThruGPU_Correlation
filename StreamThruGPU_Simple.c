...
#include <time.h>
#include <io.h>
#include "C:\publicGit\mimalloc\include\mimalloc.h"
#include <pthread.h>
...
*/
	...
	while( ! ( bDone || bStreamCompletedSuccess) )
	{
		...
		//double elapsed_time1 = (double)(end_time1 - start_time1) ;
		...
		if (g_GpuConfig.bDoAnalysis)
		{
			if (g_GpuConfig.bUseGpu)
			{
				//cudaStatus = GPU_Equation_PlusOne(d_buffer, g_GpuConfig.u32SkipFactor, g_CsAcqCfg.u32SampleSize, u32TransferSizeSamples, g_GpuConfig.i32GpuBlocks, g_GpuConfig.i32GpuThreads, u32LoopCount, stream[u32LoopCount]);
